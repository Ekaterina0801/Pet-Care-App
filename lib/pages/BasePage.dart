        ...
        appBar: AppBar(
          ...
          title: Text(widget.title,
              style: GoogleFonts.comfortaa(
                  ...
                  fontSize: 24)), automaticallyImplyLeading: ((widget.title == 'Статья')  || (widget.title == 'Болезни') || (widget.title == 'Статьи')||(widget.title=='Регистрация')|| (widget.title == 'Прививки') )?  true : false,
        ),
        body: widget.body,
